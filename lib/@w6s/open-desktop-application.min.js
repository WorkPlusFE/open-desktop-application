...
/**
     ...
     */return function(e){try{var n=e.protocol,t=e.action,o=e.query,r=e.fail,i=e.success;m(v(n),"[protocol] Must be a non-empty string"),m(v(t),"[action] Must be a non-empty string");var a="".concat(n,"://").concat(t);p(o)&&(a+="?".concat(function(e){var t=0<arguments.length&&void 0!==e?e:{};return Object.keys(t).sort().map(function(e){var n=t[e];return null==n&&(n=""),e+"="+n}).join("&")}(o))),u(a,function(e){v(r)&&r(e)},function(){v(i)&&i()},function(){v(r)&&r({supported:!1})})}catch(e){console.log(e)}}});
